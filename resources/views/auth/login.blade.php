                ...
                <div class="relative flex min-h-screen items-center justify-center bg-[url(../images/auth/map.png)] bg-cover bg-center bg-no-repeat px-6 py-10 dark:bg-[#060818] sm:px-16">
                    ...
                    <div class="relative flex w-full max-w-[1502px] flex-col justify-between overflow-hidden rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 lg:min-h-[758px] lg:flex-row lg:gap-10 xl:gap-0">
                        <div class="relative hidden w-full items-center justify-center bg-[linear-gradient(225deg,rgba(239,18,98,1)_0%,rgba(67,97,238,1)_100%)] p-5 lg:inline-flex lg:max-w-[835px] xl:-ms-32 ltr:xl:skew-x-[14deg] rtl:xl:skew-x-[-14deg]">
                            ...
                            <div class="mt-24 hidden w-full max-w-[430px] lg:block text-center">
                                <img src="assets/logo.png" alt="Cover Image" class="mx-auto w-40"> 
                            </div>
                        ...
                        <div class="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                            ...
                            <div class="w-full max-w-[440px] lg:mt-16">
                                <div class="mb-10">
                                    <h1 class="text-3xl font-extrabold uppercase !leading-snug text-primary md:text-4xl">{{ $appSetting->app_name }}</h1>
                                    <p class="text-base font-bold leading-normal text-white-dark">Masukan Email dan Password untuk masuk ke sistem</p>
                                </div>
                                <form class="space-y-5 dark:text-white" method="POST" action="{{ route('login') }}">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative text-white-dark">
                                            <input id="Email" type="email" class="form-input ps-10 placeholder:text-white-dark" placeholder="Email" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                    ...
                                    <div>
                                        ...
                                        <div class="relative text-white-dark">
                                            <input id="password" type="password"placeholder="Enter Password" class="form-input ps-10 placeholder:text-white-dark" name="password" required autocomplete="current-password">
                                            <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                                <svg width="18" height="18" viewbox="0 0 18 18" fill="none">
                                ...
                                {{-- <div class="text-center dark:text-white">
                                    ...
                                    <a href="auth-cover-register.html" class="uppercase text-primary underline transition hover:text-black dark:hover:text-white">SIGN UP</a>
                                </div> --}}
                            </div>
                            <p class="absolute bottom-6 w-full text-center dark:text-white">
                                © <span id="footer-year">2025</span>. {{ $appSetting->app_name }} Hak Cipta Dilindungi.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        @if (session('error'))
            <script>
                document.addEventListener('DOMContentLoaded', function () {
                    Swal.fire({
                        icon: 'error',
                        title: '<span style="display: block; margin-bottom: 10px; font-size: 1.5rem;">Login Gagal</span>',
                        html: '<span style="line-height: 1.6;">{{ session('error') }}</span>',
                        padding: '2em',
