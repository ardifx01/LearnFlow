    ...
    <div class="flex flex-wrap items-center justify-between mt-3 gap-4">
        ...
        <div class="flex w-full flex-col gap-4 sm:w-auto sm:flex-row sm:items-center sm:gap-3">
            <div class="flex gap-3">
                <div>
                    <a href="{{route('penilaian.create')}}" wire:navigate type="button" class="btn btn-primary">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex items-center gap-4">
                                    <a href="{{ route('penilaian.edit', $penilaian->id) }}" wire:navigate class="btn btn-sm btn-outline-info">Ubah</a>
                                    <a href="{{route('penilaian.detail', $penilaian->id)}}" wire:navigate class="btn btn-sm btn-outline-primary">Detail</a>
                                    <button type="button" wire:click.prevent="deleteContirmation({{ $penilaian->id }})" class="btn btn-sm btn-outline-danger">
                                        Hapus
                                    </button>
                                </div>
                            </td>
