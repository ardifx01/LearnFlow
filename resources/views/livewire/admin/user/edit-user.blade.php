        ...
        <div class="grid grid-cols-1 gap-4 xl:grid-cols-2">
            ...
            <div class="panel lg:col-span-2">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Tambah Superadmin</h5>
                </div>

                <div class="mb-5">
                    <form wire:submit.prevent="update" class="space-y-5">
                        <div>
                            <label for="name" class="block font-medium">Nama Superadmin</label>
                        ...
                        <div class="flex space-x-2">
                            <a href="{{ route('user') }}" wire:navigate class="btn btn-warning w-full">Batal</a>
