                ...
                <div class="mb-5" x-data="{ activeTab: 1}">
                    <div class="inline-block w-full">
                        ...
                        <div class="flex justify-between">
                            <button type="button" class="btn btn-primary" :disabled="activeTab === 1" @click="activeTab--">Kembali</button>
                            <button type="button" class="btn btn-primary" :disabled="activeTab === 2" @click="activeTab++">Selanjutnya</button>
                        </div>
                    </div>
                </div>
            </div>
