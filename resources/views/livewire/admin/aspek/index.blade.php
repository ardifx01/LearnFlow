    ...
    <div class="flex flex-wrap items-center justify-between mt-3 gap-4">
        ...
        <div class="flex w-full flex-col gap-4 sm:w-auto sm:flex-row sm:items-center sm:gap-3">
            <div class="flex gap-3">
                <div>
                    <a href="{{route('aspek.create')}}" wire:navigate type="button" class="btn btn-primary">
            ...
            <div class="relative">
                <input type="text" placeholder="Cari Kategori" class="peer form-input py-2 ltr:pr-11 rtl:pl-11" wire:model.live="search">
    ...
    <div class="panel mt-5 overflow-hidden border-0 p-0">
        <div class="table-responsive">
            <table class="table-striped table-hover">
                ...
                <tbody>
                    @forelse($aspeks as $i => $aspek)
                        <tr>
                            <td>{{ $i+1 }}</td>
                            <td>{{ $aspek->nama }}</td>
                            <td>
                                <div class="flex items-center gap-4">
                                    <a href="{{route('aspek.edit', $aspek->id)}}" wire:navigate class="btn btn-sm btn-outline-primary">
                                        Ubah
                                    </a>
                                    <button type="button" wire:click.prevent="deleteContirmation({{ $aspek->id }})" class="btn btn-sm btn-outline-danger">
                                        Hapus
                                    </button>
                                </div>
                            </td>
