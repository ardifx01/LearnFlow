    ...
    <div class="flex flex-wrap items-center justify-between mt-3 gap-4">
        ...
        <div class="flex w-full flex-col gap-4 sm:w-auto sm:flex-row sm:items-center sm:gap-3">
            <div class="flex gap-3">
                <div>
                    <a href="{{route('kategori.create')}}" wire:navigate type="button" class="btn btn-primary">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex items-center justify-center gap-4">
                                    <a href="{{route('kategori.edit', $item->id)}}" wire:navigate class="btn btn-sm btn-outline-primary">
                                        Edit
                                    </a>
