    ...
    <div class="flex flex-wrap items-center justify-between mt-3 gap-4">
        ...
        <div class="flex w-full flex-col gap-4 sm:w-auto sm:flex-row sm:items-center sm:gap-3">
            <div class="flex gap-3">
                <div>
                    <a href="{{route('kelas.create')}}" wire:navigate type="button" class="btn btn-primary">
            ...
            <div class="relative">
                <input type="text" placeholder="Cari Kelas" class="peer form-input py-2 ltr:pr-11 rtl:pl-11" wire:model.live="search">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex items-center justify-center gap-4">
                                    <a href="{{route('kelas.edit', $item->id)}}" wire:navigate class="btn btn-sm btn-outline-primary">
                                        Ubah
                                    </a>
