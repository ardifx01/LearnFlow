                ...
                <div class="px-6 py-16 text-center font-semibold before:container before:absolute before:left-1/2 before:aspect-square before:-translate-x-1/2 before:rounded-full before:bg-[linear-gradient(180deg,#4361EE_0%,rgba(67,97,238,0)_50.73%)] before:opacity-10 md:py-20">
                    <div class="relative">
                        <svg width="500" height="300" viewBox="0 0 500 300" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <text x="50%" y="40%" text-anchor="middle" font-size="80" font-weight="bold" fill="#4361EE">403</text>
                            <text x="50%" y="60%" text-anchor="middle" font-size="24" fill="#777">Tidak Diizinkan.</text>
                        </svg>
                        <p class="mt-5 text-base dark:text-white">Anda tidak memiliki izin untuk mengakses halaman ini.!</p>
                        <a href="{{ route('dashboard')}}" wire:navigate class="btn btn-gradient mx-auto !mt-7 w-max border-0 uppercase shadow-none">Home</a>
                    </div>
